...
const NoNotificationFound = () => {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="taxt-lg font-semibold mb-2 ">No notification yet</h3>
        <p className="text-base-content opacity-70 max-w-md">When you receive friend requests or messsage, they'll appear here</p>
